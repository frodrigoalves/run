...
export function TypebotEmbed() {
  return (
    <>
      <Script
        src="https://cdn.jsdelivr.net/npm/@typebot.io/js@0.3.47/dist/web.js"
      ...
      />
      <Script id="typebot-window-declaration">
        {`
            declare global {
                interface Window {
                    Typebot: {
                    initBubble: (options: any) => void;
                    };
                }
            }
        `}
